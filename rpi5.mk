...
################################################################################
override COMPILE_NS_USER   := 64/86
override COMPILE_NS_KERNEL := 64/86
override COMPILE_S_USER    := 64/86
override COMPILE_S_KERNEL  := 64/86
...
# Linux kernel
################################################################################
LINUX_DEFCONFIG_COMMON_ARCH := arm64/86
LINUX_DEFCONFIG_COMMON_FILES := \
		$(LINUX_PATH)/arch/arm64/configs/bcmrpi3_defconfig \
		$(CURDIR)/kconfigs/rpi5.conf
